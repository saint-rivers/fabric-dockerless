...
configtxgen -channelID mfn-sys-channel -profile TwoOrgsOrdererGenesis -outputBlock ./artifacts/orderer.genesis.block 
...
configtxgen --inspectChannelCreateTx ./artifacts/orderer.genesis.block > ./blocks-inspected/orderer.genesis.block.json
